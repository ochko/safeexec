...
ADD_TEST(fork-attemp "tests/driver.rb" "test-fork" "--nproc 0" "Command exited with non-zero status" "elapsed time: ? seconds" "memory usage: ? kbytes" "cpu usage: ? seconds")
ADD_TEST(file-write-attemp "tests/driver.rb" "test-write" " " "Command exited with non-zero status" "elapsed time: ? seconds" "memory usage: ? kbytes" "cpu usage: ? seconds")
ADD_TEST(return-code "tests/driver.rb" "test-ret" " " "Command exited with non-zero status" "elapsed time: ? seconds" "memory usage: ? kbytes" "cpu usage: ? seconds")
